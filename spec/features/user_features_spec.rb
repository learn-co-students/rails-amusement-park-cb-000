...
describe 'Feature Test: Admin Flow', :type => :feature do
  ...
  it 'allows admins to add an attraction' do
    ...
    fill_in("attraction_name", :with => "Haunted Mansion")
    fill_in("attraction_min_height", :with => "32")
    fill_in("attraction_happiness_rating", :with => "2")
    fill_in("attraction_nausea_rating", :with => "1")
    fill_in("attraction_tickets", :with => "4")
  ...
  it "updates an attraction when an admin edits it" do
    ...
    click_link("Show #{@rollercoaster.name}")
    click_link("Edit Attraction")
    fill_in("attraction_name", :with => "Nitro")
