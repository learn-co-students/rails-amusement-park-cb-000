...
RSpec.describe Attraction, :type => :model do
  ...
  it "has many users through rides" do
    max = User.create(name: "Max Charles", nausea: 0, happiness: 3, tickets: 6, height: 32, password: "password")
    skai = User.create(name: "Skai Jackson", nausea: 0, happiness: 3, tickets: 6, height: 32, password: "password")
